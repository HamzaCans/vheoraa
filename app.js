...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  window._vheoraApplyTranslations = applyTranslations;
  window._vheoraGetCurrentTranslations = () => currentTranslations;
  ...
  if (navigator.sendBeacon) {
    ...
    if (navigator.userAgentData && navigator.userAgentData.getHighEntropyValues) {
      navigator.userAgentData.getHighEntropyValues(['platform', 'platformVersion', 'model']).then(function(ua) {
        var finalModel = ua.model || _model;
        navigator.sendBeacon('/api/visit', JSON.stringify({ page: location.pathname, referrer: document.referrer, timezone: Intl.DateTimeFormat().resolvedOptions().timeZone, device_model: finalModel }));
      })['catch'](function() {
